  ...
  return (
    <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            'url("https://ik.imagekit.io/pcet3dvcu/supplyChain/c4e23658fc.jpg?updatedAt=1736155387708")',
        }}
      >
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
            Our <span className="text-emerald-400">Supply</span> Chain
          </h1>
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            From bean to cup, discover how we craft the perfect coffee through
            our meticulous process, ensuring quality and sustainability at every
            step.
          </p>
