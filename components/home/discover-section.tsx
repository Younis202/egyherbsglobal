...
export function DiscoverSection() {
  ...
  const whatsappUrl = `https://wa.me/201222297357?text=${encodeURIComponent(
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          ...
          style={{
            backgroundImage:
              'url("https://ik.imagekit.io/pcet3dvcu/home/12.jpg?updatedAt=1726259343720")',
          }}
        >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-white mb-6 leading-tight">
            Discover the{" "}
            <span className="text-emerald-300">Egyptian Herbs</span> Difference
          </h2>

          <p className="text-xl text-emerald-100 mb-10 leading-relaxed">
            Experience the finest quality herbs and spices, sourced directly
            from nature and delivered to your doorstep. Join us in our
            commitment to quality, sustainability, and exceptional flavor.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href={whatsappUrl} target="_blank" rel="noopener noreferrer">
              <Button
                size="lg"
                variant="outline"
                className="text-white border-white bg-white/10 hover:bg-white/20 px-8 py-6 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105 flex items-center gap-2"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            {[
              ...
              >
                <p className="text-3xl md:text-4xl font-bold text-emerald-300 mb-1">
                  {stat.number}
                </p>
