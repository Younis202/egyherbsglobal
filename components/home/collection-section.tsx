...
const collections = [
  {
    ...
    image:
      "https://ik.imagekit.io/pcet3dvcu/home/Herbs-1.jpg?updatedAt=1736081793544",
    items: "24+ varieties",
    link: "/products",
  },
  {
  ...
  },
  {
    ...
    image:
      "https://ik.imagekit.io/pcet3dvcu/home/SUN-FLOWER-SEEDS.jpg?updatedAt=1736082173051",
    items: "20+ varieties",
    link: "/products",
  },
  {
    ...
    image:
      "https://ik.imagekit.io/pcet3dvcu/home/82e7ab67cd.jpg?updatedAt=1736082572058",
    items: "20+ varieties",
    link: "/products",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mt-6">
            Explore our diverse range of premium herbs, spices, seeds, and
            legumes, sourced directly from nature's finest.
          </p>
        </motion.div>
          ...
          {collections.map((collection, index) => (
            ...
            >
              <Card className="overflow-hidden h-full border-0 shadow-xl rounded-xl group">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-semibold mb-2 text-gray-900 group-hover:text-emerald-600 transition-colors">
                    {collection.title}
                  </h3>
                  ...
                  <Link href={collection.link}>
                    <Button
                      variant="outline"
                      className="w-full border-emerald-600 text-emerald-600 hover:bg-emerald-50 group"
                    >
