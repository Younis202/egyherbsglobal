...
import { Award, Check, Leaf, Shield, Truck } from "lucide-react";
...
const reasons = [
  {
    ...
    description:
      "We source only the highest quality herbs and spices from trusted farmers worldwide.",
  },
  {
    icon: Leaf,
    title: "Organic & conventional",
    description:
      "All our products are certified organic and free from artificial additives.",
  },
  {
    icon: Truck,
    title: "Fast Delivery",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-10">
              We're committed to providing the highest quality herbs and spices
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                  ...
                  <p className="text-gray-900 font-medium italic">
                    "The quality of their herbs is unmatched. You can taste the
                    difference in every dish."
                  </p>
