      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
            Crafting <span className="text-emerald-400">Excellence</span> Since 2010
          </h1>
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            Discover the passion and dedication behind Egy Herbs Global, bringing Egypt's finest herbs 
            and spices to the world through sustainable practices and unwavering quality standards.
          </p>
