...
export function CTA() {
  ...
  const whatsappUrl = `https://wa.me/201234567890?text=${encodeURIComponent("Hello! I'm interested in your products. Can you provide more information?")}`;
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-emerald-200 font-medium mb-1">WhatsApp</p>
                  <p className="text-white text-lg">+20 123 456 789</p>
                  <Link href={whatsappUrl} target="_blank" rel="noopener noreferrer">
                    <Button 
                      variant="outline" 
                      className="mt-2 border-white/30 text-white hover:bg-white/10 flex items-center gap-2"
                    >
